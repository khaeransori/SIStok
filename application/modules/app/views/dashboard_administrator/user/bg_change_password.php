...
<?php if($this->session->flashdata('pass_fail')) { ?>
    <div class="alert alert-error">
        ...
        <?php echo $this->session->flashdata('pass_fail'); ?>
    </div>
<?php } ?>
<?php if($this->session->flashdata('pass_success')) { ?>
    <div class="alert alert-success">
        <button type="button" class="close" data-dismiss="alert">×</button>
        <h4>Berhasil!</h4>
        <?php echo $this->session->flashdata('pass_success'); ?>
    </div>
<?php } ?>
        ...
        <div class="tab-content">
            <div class="tab-pane <?php echo $a; ?>" id="lA">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" value="<?php echo $this->session->userdata('sess_user'); ?>" 
            ...
            <div class="tab-pane <?php echo $b; ?>" id="lB">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" value="<?php echo $this->session->userdata('sess_nama'); ?>" 
